...
public class ContaBancaria {
    ...
    void abrirConta() throws SQLException {
            ...
            while (true) {
                try {
                    System.out.println("Qual tipo da conta? 'C' para conta corrente ou 'P' para conta poupança");
                    ...
                    if (tipo_conta.equals("C")) {
                        ...
                        System.out.println("Por favor, insira apenas 'C' para conta corrente ou 'P' para conta poupança.");
                    }
                } catch (Exception e) {
                    System.out.println("Ocorreu um erro durante a leitura da entrada do usuário.");
                    tipoForm.next(); // Limpa o buffer do Scanner para evitar um loop infinito
                }
            }
